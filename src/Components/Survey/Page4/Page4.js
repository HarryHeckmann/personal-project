        ...
        return(
            <div className='wizard4'>
                ...
                <div className='surveyDiv4'>
                    ...
                    <div className='surveyButtons4'>
                        <button className={this.state.exerciseClicked1 ? 'surveyButtonClicked' : 'surveyButton'} onClick={() => this.clickedExercise(1)}>I work out by using a tv remote</button>
                        <button className={this.state.exerciseClicked2 ? 'surveyButtonClicked' : 'surveyButton'} onClick={() => this.clickedExercise(2)}>I exercise occasionaly</button>
                        <button className={this.state.exerciseClicked3 ? 'surveyButtonClicked' : 'surveyButton'} onClick={() => this.clickedExercise(3)}>I exercise almost every day</button>
                    </div>
                    <div>
